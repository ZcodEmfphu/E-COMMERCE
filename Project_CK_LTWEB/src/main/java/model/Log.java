...
public class Log {
	...
	public Log(int id,int level, String src, String userName, String content, Date creatAt, int status) {
		this.id = id;
		this.level = level;
		this.src = src;
	...
	public model.api.Date converDate() {
		return DateTime.formatDate(creatAt.toString());
	}
}
